	...
	public function getCities($countryCode, $adminType = null, $adminCode = null): JsonResponse
	{
		...
		if (!empty($adminCode)) {
			if (!empty($admin)) {
				...
				$title = '<a href="" data-url="' . $baseUrl . '" class="btn btn-sm btn-success is-admin go-base-url" data-ignore-guard="true">';
			...
			if (in_array($countryAdminType, ['1', '2'])) {
				...
				$title .= '<a href="" data-url="' . $goBaseUrl . '" class="btn btn-sm btn-success is-admin go-base-url" data-ignore-guard="true">';
