 ...
 * @return string
 */
function generateRandomString(int $length = 6, string $type = 'numeric'): string
{
 ...
 * @return array
 */
function getFormattedThemes($theme = null): array
{
	...
	$userThemes = collect($userThemes)
		->map(function ($item) {
			$themeIcons = [
				...
				'dark'   => '<i class="bi bi-moon"></i>', // <i class="bi bi-moon"></i>
				'system' => '<i class="bi bi-gear"></i>', // <i class="bi bi-circle-half"></i>
			];
