			...
			<div class="col-12 px-1 py-sm-1 bg-primary rounded">
				<div class="row gx-1 gy-1">
					...
					@include('helpers.forms.fields.select2', [
						...
						'value'       => $qCategory,
						'hint'        => null,
						'baseClass'   => ['wrapper' => 'col-xl-3 col-md-3 col-sm-12 col-12'],
					])
					...
					@include('helpers.forms.fields.text', [
						...
						'baseClass'   => [
							'field'   => "form-control locinput input-rel searchtag-input{$autocompleteClass}",
							'wrapper' => 'col-xl-3 col-md-3 col-sm-12 col-12 search-col locationicon'
						],
					])
