								...
								>
									...
									<fieldset>
										...
										@php
											...
											$aClass = 'class="cat-link open-selection-url"';
										...
										@else
											@include('helpers.forms.fields.checkbox-switch', [
										...
										<div class="row mb-3 mt-5">
											<div class="col-md-6 text-start">
												<a href="{{ url()->previous() }}" class="btn btn-default btn-lg btn-block">
													{{ t('Cancel') }}
												</a>
											</div>
											<div class="col-md-6 text-end">
												<button id="nextStepBtn" class="btn btn-primary btn-lg btn-block">
													{!! $nextStepLabel !!}
												</button>
											</div>
										</div>
